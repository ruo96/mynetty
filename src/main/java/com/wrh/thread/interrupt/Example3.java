...
public class Example3 extends Thread {
    public static void main(String args[]) throws Exception {
        ...
        System.out.println("second: "+ thread.isInterrupted());
        Thread.sleep(3000);
    ...
    public void run() {
        while (!Thread.currentThread().isInterrupted()) {
            ...
            try {
                 ...
                 * 过程中受阻，则其中断状态将被清除
                 */
                System.out.println("before interrupt "+this.isInterrupted());// false

                //中不中断由自己决定，如果需要真真中断线程，则需要重新设置中断位，如果
                //不需要，则不用调用
                Thread.currentThread().interrupt();
                System.out.println("after interrupt "+ this.isInterrupted());
            }
        }
