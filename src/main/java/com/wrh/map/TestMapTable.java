 ...
 * @Created by wrh
 * @Description:
 * @Date: Created in 下午 2:29 2019/1/17 0017
 * @Modified By:
 */
public class TestMapTable {
    ...
    public static void main(String[] args) {
        ...
        hashtable.put("t2", "2");
        hashtable.put("t3", "3");
        Enumeration<Map.Entry<String, String>> iterator1 =
                (Enumeration<Map.Entry<String, String>>) hashtable.entrySet().iterator();
